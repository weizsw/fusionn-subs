...
Provide a flexible, multi-provider translation service for subtitle files that supports different LLM providers (OpenRouter, Gemini) and adapts to configuration changes without service restarts.
## Requirements
